...
@WebServlet(urlPatterns = "/moreproducts")
public class MoreProductsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher rd = req.getRequestDispatcher("moreProducts.jsp");
            rd.forward(req, resp);

        } catch (Exception e) {
            e.printStackTrace();
            resp.sendRedirect("moreProducts.jsp?error=Failed to retrieve products or cart items");
        }
    }
}
